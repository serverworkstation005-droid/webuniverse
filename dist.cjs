...
function replaceDomains(content) {
  return content.replace(/4khdhub\.link/g, "4khdhub.one").replace(/uhdmovies\.pink/g, "uhdmovies.food").replace(/uhdmovies\.rodeo/g, "uhdmovies.food").replace(/olamovies\.mov/g, "v2.olamovies.mov").replace(/a\.olamovies\.mov/g, "v2.olamovies.mov").replace(/vegamovies\.market/g, "vegamovies.mq").replace(/new1\.hdhub4u\.limo/g, "new1.hdhub4u.cl").replace(/hdhub4u\.limo/g, "new1.hdhub4u.cl").replace(/downloadhub\.christmas/g, "downloadhub.lat").replace(/allmovieshub\.gripe/g, "allmovieshub.gives").replace(/allmovieshub\.agency/g, "allmovieshub.gives").replace(/india4movies\.my/g, "go.india4movies.net");
}
